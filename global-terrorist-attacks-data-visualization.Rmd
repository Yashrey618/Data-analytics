...
##matrix plot for finding  number of missing(NA) values in the attributes
...
# Analysis by line plot with pointed marker
## Events by year
...
##comparison by horizontal bar graph
```{r fig.width=14}
